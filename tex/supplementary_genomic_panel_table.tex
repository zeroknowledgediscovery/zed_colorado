...
\end{adjustbox}
\vspace{2pt}
\parbox{0.98\textwidth}{\tiny $^{\dagger}$\textit{MUC5B} rs35705950; $^{\ast}$\textit{TERT} rs2736100. The complete machine-readable inventory, including processed locus tokens and manuscript roles, is provided in \texttt{supplementary\_genomic\_panel\_inventory.csv}. Historical assignment of individual retained variants to the original biological-driver list versus the supplemental candidate expansion cannot be reconstructed reliably because the original restricted \texttt{biological\_drivers.csv} source is not retained.}
\end{table*}
