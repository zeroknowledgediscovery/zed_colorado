...
Notation & Meaning \\
\midrule
$b_{\delta,n}$ & Finite-stage $(1-\delta)$ residual-genomic log-LR scale at a particular clinical-history stage $n$; no uniformity over history length is assumed. \\
$b_{\delta}$ & A single $n$-independent residual-genomic bound available only under the stronger uniform-tightness condition A1-U. \\
\bottomrule
\end{tabular}
\end{center}
\noindent We use the subscript $n$ precisely to distinguish the empirically relevant finite-stage quantity from the stronger sequential bound.
